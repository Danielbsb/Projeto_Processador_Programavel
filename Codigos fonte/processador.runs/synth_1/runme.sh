...
HD_PWD='C:/Users/Haroldo/Documents/PCID/processador/processador.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log processador_top.vds -m64 -mode batch -messageDb vivado.pb -notrace -source processador_top.tcl
