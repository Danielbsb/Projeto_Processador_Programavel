...
HD_PWD='C:/Users/Daniel/Documents/Projeto_Processadores/Projeto_Processador_Programavel/Vivado project/project_I7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log super_top_level.vds -m64 -mode batch -messageDb vivado.pb -notrace -source super_top_level.tcl
