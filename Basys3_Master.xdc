...
##7 segment display
    set_property PACKAGE_PIN W7 [get_ports {segmentos[7]}]
        set_property IOSTANDARD LVCMOS33 [get_ports {segmentos[7]}]
    set_property PACKAGE_PIN W6 [get_ports {segmentos[6]}]                    
        set_property IOSTANDARD LVCMOS33 [get_ports {segmentos[6]}]
    set_property PACKAGE_PIN U8 [get_ports {segmentos[5]}]                    
        set_property IOSTANDARD LVCMOS33 [get_ports {segmentos[5]}]
    set_property PACKAGE_PIN V8 [get_ports {segmentos[4]}]                    
        set_property IOSTANDARD LVCMOS33 [get_ports {segmentos[4]}]
    set_property PACKAGE_PIN U5 [get_ports {segmentos[3]}]                    
        set_property IOSTANDARD LVCMOS33 [get_ports {segmentos[3]}]
    set_property PACKAGE_PIN V5 [get_ports {segmentos[2]}]                    
        set_property IOSTANDARD LVCMOS33 [get_ports {segmentos[2]}]
    set_property PACKAGE_PIN U7 [get_ports {segmentos[1]}]                    
        set_property IOSTANDARD LVCMOS33 [get_ports {segmentos[1]}]
    
    set_property PACKAGE_PIN V7 [get_ports {segmentos[0]}]
...
set_property PACKAGE_PIN U18 [get_ports clk_m]		
	...
	set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets clk_m_IBUF]
