...
assign leds=s_leds;
Unidade_controladora Unidade_controladora(clk_m,RF_Rp_zero,D_addr,D_rd,D_wr,RF_W_data,RF_s1,RF_s0,RF_W_addr,RF_W_wr,RF_Rp_addr,RF_Rp_rd,RF_Rq_addr,RF_Rq_rd, ALU_s,shift,sw);
datapath datapath(clk_m,D_addr, D_rd, D_wr, RF_W_data, RF_s1, RF_s0, RF_W_addr, RF_W_wr, RF_Rp_addr, RF_Rp_rd, RF_Rq_addr, RF_Rq_rd, ALU_s, shift, RF_Rp_zero);
